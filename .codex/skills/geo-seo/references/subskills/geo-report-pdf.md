...
1. Read `GEO-AUDIT-REPORT.md` in the current directory (created by `GEO task audit`)
...
The pandoc template (`<geo-seo-skill-root>/templates/geo-report-template.html`) injects:
...
Look for `GEO-AUDIT-REPORT.md` in the current directory. If absent, tell the user to run `GEO task audit <url>` first.
...
pandoc GEO-AUDIT-REPORT.md \
  ...
  --standalone \
  --embed-resources \
  --template <geo-seo-skill-root>/templates/geo-report-template.html \
  --css <geo-seo-skill-root>/templates/geo-report-style.css \
...
- **Colors / typography** — Edit `<geo-seo-skill-root>/templates/geo-report-style.css`
- **Cover layout** — Edit `<geo-seo-skill-root>/templates/geo-report-template.html`
