...
```
GEO task compare <domain>
GEO task compare <baseline-file> <current-file>
GEO task compare electron-srl.com --month march-2026
```

**Examples:**
```
GEO task compare electron-srl.com
GEO task compare ~/.geo-prospects/audits/electron-srl.com-2026-01-15.md ~/.geo-prospects/audits/electron-srl.com-2026-03-12.md
```
...
5. If no files exist: suggest running `GEO task prospect audit <domain>` first
...
2. Print confirmation with key stats:
   ...
   ```
3. Suggest next action: "Share with client or run `GEO task report-pdf` for a visual version"
